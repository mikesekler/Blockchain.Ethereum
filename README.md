...
## How to run the Events Service Spring Boot Microservice outside a container
### With Maven
```
  cd EventsService
...
```
## Microservices Containerization with Docker
This is done by building a Docker image with a Dockerfile generated by the [fabric8io](https://github.com/fabric8io/docker-maven-plugin) maven plugin:
```
...
### Docker Compose
Below docker-compose.yml file links the containers through the "links" attribute, but it could through the networks attributes too.
